import type { GridType, SpeedType, TileType } from "../../../utils/types.ts";
import { getRandInt, isEqual, sleep } from "../../../utils/helpers.ts";
import { SPEEDS, WALL_TILE_STYLE } from "../../../utils/constants.ts";
import { recursiveDivision } from "./recursiveDivision.ts";
